        ...
        const itemEl = div({
            ...
            children: [
                div({
                    ...
                    // registerIcon records the shipped source and returns the recolored
                    // one when an iconColor is already applied, so a re-render does not
                    // pop the icon back to blue.
                    children: [img({
                        className: 'menu-icon',
                        src: registerIcon(itemData.id, itemData.iconSrc),
                        alt: itemData.label,
                        'data-accent-icon': itemData.id,
                    })]
                }),
                span({
