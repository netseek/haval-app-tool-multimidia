...
| **v2.6+** | CLUSTER as a **second** H.264 stream (MAIN stays on D0) | Service-APK helper [`patch_android_auto_service_cluster.py`](patch_android_auto_service_cluster.py). Not the old "lie MAIN is CLUSTER" idea in [TODO_v2_5_display_type_cluster.md](TODO_v2_5_display_type_cluster.md). Dumps: [DUMPS_V2_6_CLUSTER.md](DUMPS_V2_6_CLUSTER.md). Unproven on the car. |
